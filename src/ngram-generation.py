...
four_gram = (pd.Series(nltk.ngrams(word_list, 4)).value_counts())[:4000]
...
three_gram = (pd.Series(nltk.ngrams(word_list, 3)).value_counts())[:4000]
...
two_gram = (pd.Series(nltk.ngrams(word_list, 2)).value_counts())[:4000]
